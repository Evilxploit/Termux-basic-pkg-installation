...
time.sleep(0.1)
print("\033[93m"+"*"*49)
banner = pyfiglet.figlet_format("BASIC PKG")
print("\033[93m" + banner)
print("\033[93m"+"*"*17+"coded by T4NJ1L"+"*"*17)
time.sleep(0.3)
print("\033[92m"+'''
1. pkg update
2. pkg update
...
12. apt install host
13. apt install nano
14. apt install cmatrix
15. apt install figlet
16. apt install wget
17. apt install toilet
18. apt insatll cowsay
19. apt insatll ruby
20. gem install lolcat
21. apt install curl
22. apt install unzip
23. apt install openssh
24. apt install tor
25.apt install net-tools
26. apt install unrar
27. apt install w3m
28. apt install proot
29. pip install requests
30. pip install  --upgrade pip
31. pip2 install  --upgrade pip
32. pip install future
33. pip install youtube-dl
34. pkg install weechat-python-plugin
35. pkg install python2-static
36. pkg install python-tkinter
37. pkg install vim-python
38. pkg install python-static
''')
print("\033[91m"+"All pkg that will be installed through this tool")
inp = input("\033[95m"+"ENTER YOUR CHOICE (Y/N): ")

if inp =="Y" :
  
  print("\033[96m"+"Hello Newbes....!!!!!! ")
  time.sleep(2)
